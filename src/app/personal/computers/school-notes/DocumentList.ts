export class PdfNotesNode {
    title?: string;
    number?: string;
    path?: string;
    cGrade?: boolean;
    documents?: PdfNotesNode[];
}

export const basePath = '/assets/personal/school-notes/';

export const SchoolNotesList: PdfNotesNode[] = [
    {
        title: 'Sciences',
        documents: [
            ...
            { number: 'PH 2550',    title: 'Atmospheric and Space Environments',                                path: 'ph2550.pdf' }
        ]
    },
    {
        ...
        documents: [
            ...
            { number: 'CS 4515',    title: 'Computer Architecture',                                             path: 'cs4515.pdf' },
    ...
    },
    {
        title: 'Projects',
        documents: [
            { number: 'ID 2050',    title: 'Converting Eilat to Electric Vehicles',                                                  path: 'IQP_Proposal.pdf'},
