...
export const LatexCarouselImages: Image[] = [
    {
        image: '/assets/personal/latex/resume.png',
        alt: 'Personal resume',
        caption: 'My personal resume, made with the ModernCV package'
    },
    {
        image: '/assets/personal/latex/mqp-one-pager.png',
        alt: 'MQP one-pager',
    ...
    {
        image: '/assets/personal/latex/poems.png',
    ...
    {
        image: '/assets/personal/latex/bme3300.png',
    ...
    {
        image: '/assets/personal/latex/bar-association.png',
    ...
    {
        image: '/assets/personal/latex/iqp.png',
        alt: 'IQP report',
    ...
    {
        image: '/assets/personal/latex/mqp.png',
        alt: 'MQP report',
    ...
    {
        image: '/assets/personal/latex/paris-knight.png',
